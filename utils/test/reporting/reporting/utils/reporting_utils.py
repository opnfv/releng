        ...
        for test_r in test_results:
            if (test_r['stop_date'] != 'None' and
                ...
                if 'arm' in test_r['pod_name']:
                    if not test_r['scenario'] in scenario_results['arm']:
                        scenario_results['arm'][test_r['scenario']] = []
                    scenario_results['arm'][test_r['scenario']].append(test_r)
                else:
                    if not test_r['scenario'] in scenario_results['x86']:
                        scenario_results['x86'][test_r['scenario']] = []
                    scenario_results['x86'][test_r['scenario']].append(test_r)
