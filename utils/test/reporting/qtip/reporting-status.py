...
def render_html(result_criterias, installer, version):
    ...
    render_outcome = template.render(scenario_results=result_criterias,
                                     installer=installer,
                                     period=PERIOD,
                                     version=version,
                                     date=reportingDate)
...
def render_reporter():
    for version in versions:
        ...
        for installer in installers:
            ...
            result_criterias = profile_results(results, installer, profile_fd)
            render_html(result_criterias=result_criterias,
                        installer=installer,
                        version=version)
        profile_fd.close()
