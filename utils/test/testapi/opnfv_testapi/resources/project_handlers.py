...
class ProjectCLHandler(GenericProjectHandler):
    @swagger.operation(nickname="List Projects")
    def get(self):
        """
    ...
    @swagger.operation(nickname="Create Project")
    def post(self):
        """
...
class ProjectGURHandler(GenericProjectHandler):
    @swagger.operation(nickname='Get Project')
    ...
    @swagger.operation(nickname="Update Project")
    ...
    @swagger.operation(nickname='Delete Project')
