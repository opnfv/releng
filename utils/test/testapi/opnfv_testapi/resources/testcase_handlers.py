...
class TestcaseCLHandler(GenericTestcaseHandler):
    @swagger.operation(nickname="List TestCases")
    ...
    @swagger.operation(nickname="Create TestCase")
...
class TestcaseGURHandler(GenericTestcaseHandler):
    @swagger.operation(nickname='Get TestCase')
    ...
    @swagger.operation(nickname="Update TestCase")
    ...
    @swagger.operation(nickname='Delete TestCase')
