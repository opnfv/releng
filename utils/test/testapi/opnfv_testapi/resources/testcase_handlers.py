...
class TestcaseCLHandler(GenericTestcaseHandler):
    @swagger.operation(nickname="listAllTestCasesByProjectName")
    ...
    @swagger.operation(nickname="createTestCaseByProjectName")
...
class TestcaseGURHandler(GenericTestcaseHandler):
    @swagger.operation(nickname='getTestCaseByProjectAndCaseNames')
    ...
    @swagger.operation(nickname="updateTestCaseByProjectAndCaseNames")
    ...
    @swagger.operation(nickname='deleteTestCaseByProjectAndCaseNames')
