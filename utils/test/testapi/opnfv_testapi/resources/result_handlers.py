        ...
        """
            ...
            @notes: Retrieve result(s) for a test project on a specific pod.
                Available filters for this request are :
                 ...
                 - period : x (x last days), if it is set, from/to shouldn't be set
                 - from : starting time written in 2016-01-01 or 2016-01-01 00:01:23
                 - to : ending time written in 2016-01-01 or 2016-01-01 00:01:23
