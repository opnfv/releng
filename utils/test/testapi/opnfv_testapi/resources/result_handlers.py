...
class ResultsCLHandler(GenericResultHandler):
    @swagger.operation(nickname="List Test Results")
    def get(self):
        """
    ...
    @swagger.operation(nickname="Create Test Result")
    def post(self):
        """
...
class ResultsGURHandler(GenericResultHandler):
    @swagger.operation(nickname='Get Test Result')
    ...
    @swagger.operation(nickname="Update Test Result")
