...
class TestScenarioUpdate(TestScenarioBase):
    ...
    def test_addScore(self, scenario):
        ...
        installer = scenario['installers'][0]
        installer_name = installer['installer']
        version = installer['versions'][0]
        ...
        self.update_url = '/api/v1/scenarios/{}/installers/{}/versions/' \
                          '{}/projects/{}/scores'.format(
            self.scenario, installer_name, version_name, 'functest')
