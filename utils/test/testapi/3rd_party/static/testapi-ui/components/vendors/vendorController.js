...
(function () {
    ...
    VendorController.$inject = [
        ...
        '$uibModal', 'testapiApiUrl', 'raiseAlert', 'confirmModal'
    ];
    ...
    function VendorController($rootScope, $scope, $http, $state, $stateParams,
            $window, $uibModal, testapiApiUrl, raiseAlert, confirmModal) {
        var ctrl = this;
        ...
        function getVendor() {
            ...
            var contentUrl = testapiApiUrl + '/vendors/' + ctrl.vendorId;
            ctrl.vendorRequest =
        ...
        function registerVendor() {
            var url = [testapiApiUrl, '/vendors/', ctrl.vendorId,
                       '/action'].join('');
        ...
        function deleteVendor() {
            var url = [testapiApiUrl, '/vendors/', ctrl.vendorId].join('');
        ...
        function getVendorProducts() {
            ctrl.showError = false;
            var contentUrl = testapiApiUrl + '/products?organization_id='
                              + ctrl.vendorId;
    ...
    VendorEditModalController.$inject = [
        '$rootScope',
        '$uibModalInstance', '$http', '$state', 'vendor', 'testapiApiUrl'
    ];
    ...
    function VendorEditModalController($rootScope, $uibModalInstance, $http,
        ...
        function saveChanges() {
            ...
            var url = [testapiApiUrl, '/vendors/', ctrl.vendor.id].join('');
