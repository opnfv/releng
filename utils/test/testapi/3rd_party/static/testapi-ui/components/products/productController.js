...
(function () {
    ...
    function ProductController($scope, $http, $state, $stateParams,
            $window, $uibModal, testapiApiUrl, raiseAlert) {
        var ctrl = this;
        ...
        function getProduct() {
            ...
            ctrl.product = null;
            var content_url = testapiApiUrl + '/products/' + ctrl.id;
        ...
        function deleteProduct() {
            var url = [testapiApiUrl, '/products/', ctrl.id].join('');
        ...
        function deleteProductVersion(versionId) {
            var url = [
                testapiApiUrl, '/products/', ctrl.id,
        ...
        function addProductVersion() {
            var url = [testapiApiUrl, '/products/', ctrl.id,
                '/versions'].join('');
    ...
    ProductVersionModalController.$inject = [
        '$uibModalInstance', '$http', 'testapiApiUrl', 'version', 'parent'
    ];
    ...
    function ProductVersionModalController($uibModalInstance, $http,
        ...
        function saveChanges() {
            ...
            ctrl.showError = false;
            var url = [
                testapiApiUrl, '/products/', ctrl.version.product_id,
    ...
    function ProductEditModalController($uibModalInstance, $http,
        $state, product, version, testapiApiUrl) {
        ...
        function saveChanges() {
            ctrl.showError = false;
            ctrl.showSuccess = false;
            var url = [testapiApiUrl, '/products/', ctrl.product.id].join('');
