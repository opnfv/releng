...
def format_vPing_userdata_for_dashboard(results):
    """
    Post processing for the vPing-userdata test case
    """
    test_data = [{'description': 'vPing-userdata results for Dashboard'}]
    ...
    test_data.append({'name': "vPing-userdata duration",
                      'info': {'type': "graph",
                               'xlabel': 'time',
                               'ylabel': 'duration (s)'},
                      'data_set': new_element})
