...
from resources.handlers import VersionHandler, PodHandler, TestProjectHandler, TestCasesHandler, TestResultsHandler
...
def make_app():
    return tornado.web.Application(
        [
            ...
            # POST /results => Push results with mandatory request payload parameters (project, case, and pod_id)
