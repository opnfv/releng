...
class ContainerizedCompassAdapter():
    ...
    def __init__(self, installer_ip, installer_user, pkey_file):
        ...
        self.SRC_PATH_UC = "/etc/openstack_deploy/openstack_user_config.yml"
        self.nodes = []
        self.ROLES = {}
    ...
    def get_nodes(self, options=None):
        ...
        functest_container = client.containers.list(
            filters={'ancestor': 'opnfv/functest-features'})
        functest_container[0].exec_run(
            'docker cp compass-tasks:{0} /tmp'.format(self.SRC_PATH_UC))
