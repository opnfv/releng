...
sudo -E ansible-playbook -i inventory jumphost_configuration.yml -vvv
...
echo "set UP Host !"
sudo -E /bin/sh -c "ssh root@$JUMPHOST_IP openstack-ansible \
...
sudo -E /bin/sh -c "ssh root@$JUMPHOST_IP ansible -i $PLAYBOOK_PATH/inventory/ \
