...
# Use a timestamp in the ISO image, and save the name in latest.properties
ISO_FILE=${WORKSPACE}/opnfv-$(date +%Y%m%d%H%M).iso
echo "ISO_FILE=${ISO_FILE}" >> latest.properties
